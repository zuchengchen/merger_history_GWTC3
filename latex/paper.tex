...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% title %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\title{The merger history of primordial-black-hole binaries implied by GWTC-3}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% author %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\author{You~Wu}
%\email{Corresponding author: youwuphy@gmail.com}
...
\begin{figure}[htbp!]
	\centering
	\includegraphics[width = 0.48\textwidth]{posterior-log.pdf}
...
\begin{figure}[htbp!]
	\centering
	\includegraphics[width = 0.48\textwidth]{posterior-power.pdf}
...
We thank the anonymous referee for providing constructive comments and suggestions to improve the quality of this paper. 
We would also like to thank Zu-Cheng Chen and Lang Liu for useful conversations.
